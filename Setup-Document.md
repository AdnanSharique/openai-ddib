...
5. **Execute** the openaiSetup.ps1 script by executing the following command:
...
17. You will now be prompted to **enter** the resource group name in the Azure Cloud Shell. **Type** the same resource group name that you created in [Task 1](#task-1-create-a-resource-group-in-azure). – 'rg-openai-ddib'.
